...
var numStanze = 0;
        ...
        var submitButton2 = document.querySelector("button#buttStanze");
                ...
                //alert("Inizio con la submit " + butt.attr("id"));
                var datiValidi = validateForm(butt);
                if (datiValidi){
                    for (i = 1; i < dropzones.length; i++){
                    if (dropzones[i] != null){
                        //alert("INVIO DATI STANZA " + i);
...
//MODIFICHE ATTUALI
        ...
        numStanze++;
                ...
                var myForm = $('form#formStanza' + numStanze);
                addFormStanza(myForm, numStanze);
