<%-- 
    Document   : newjsp
    Created on : Apr 30, 2016, 4:03:08 PM
   ...
   // [START region_fillform]
    function fillInAddress() {
        ...
        for (var i = 0; i < place.address_components.length; i++) {
            ...
            var indirizzo = componentString['route'] + ", " + componentString['street_number'];
        console.log("Indirizzo trovato " + indirizzo);
        document.getElementById('autocomplete').value = indirizzo;  
}
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC2yod6637sOZqbmDNOZSUh-30b6xTchBE&signed_in&libraries=places&callback=initAutocomplete"
        async defer></script>
  </body>
</html>